  ...
  return (
    <div>
      ...
      <div className="card">
        ...
        {metaLoading && (
          <p className="meta-status">Loading dropdown options...</p>
        )}

        {metaError && (
          <p className="meta-status warning">
            Using manual inputs because metadata could not be loaded.
          </p>
        )}
